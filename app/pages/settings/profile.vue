<template>
  <UForm :state="state" :schema="schema" @submit="saveProfile">
    ...
    <UFormGroup class="mb-4" label="Email" name="email" help="You will receive a confirmation email on both the old and the new addresses if you modify the email address">
...
const saveProfile = async () => {
  ...
  try {
    ...
    toastSuccess({
      ...
      description: 'Yuor profile has been updated'
    })
  } catch(e) {
